...
export default class Render2DComponent extends AbstractComponent implements Render2DComponentInterface {
    ...
    constructor(image?: HTMLImageElement|HTMLCanvasElement){
        super();
        this.nameSpace = ComponentNameSpace.Render2DComponent;
    ...
    awake(){
        ...
        this.positionComp = <Position2DComponents>this.getComponent(ComponentNameSpace.Position2DComponents);
    ...
    render(){
        ...
        if(this.positionComp.IsDirty || this.isDirty){
            ...
            this.publishEvent(ComponentEvents.Render,this.canvas, this.positionComp.X, this.positionComp.Y);
            this.isDirty = false;
